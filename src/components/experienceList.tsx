  ...
  return (
    <div className="flex flex-col space-y-10 justify-center mt-24 w-full ">
      ...
      <Card id="cmu">
        ...
        {/*         </li> */}
        {/*         <li className='p-3 hover:bg-primary '> */}
        {/*           <a href='https://www.diderot.one/courses/121' target='_blank'> */}
      ...
      <Card id="cyphercor">
        <div className="flex flex-row space-x-4 justify-center items-center">
          <img className="h-auto w-1/2 md:w-1/3 lg:w-1/4 " src={cyphercorUrl} />
        </div>
        <div className="flex flex-col justify-center items-center">
          <div className="flex flex-col space-y-0.5 items-center">
            <h5 className="text-sm font-semibold italic ">
              Sept. 2021 - Sept. 2022: Ottawa, ON, Canada
            </h5>
          </div>
          <h5 className="text-lg lg:text-xl text-center font-bold ">
            Software Engineer
        ...
        {/*         </li> */}
        {/*         <li className='p-3 hover:bg-primary '> */}
        {/*           Implemented time zone settings for the admin panel so that all */}
        {/*           tokens' expiry time, users' login times, subscription's */}
        ...
        {/*           organization is huge by just tweaking database queries &mdash; */}
        {/*           the request time drops from over 10s to just above 200ms. */}
        {/*         </li> */}
        {/*       </ul> */}
        ...
        {/*           the speed of the requests invoking these queries soar by 10x. */}
        {/*         </li> */}
        {/*       </ul> */}
        {/*     </div> */}
        {/*   </Accordion> */}
      ...
      <Card id="waterloo">
        <div className="flex flex-row space-x-4 justify-center items-center">
          <img className="h-auto w-1/2 md:w-2/5 lg:w-1/3 " src={uwaterlooUrl} />
        </div>
        <div className="flex flex-col justify-center items-center">
          <div className="flex flex-col space-y-0.5 items-center">
            <h5 className="text-sm font-semibold italic ">
              Sept. 2020 - Aug. 2021: Waterloo, ON, Canada
            </h5>
          </div>
          <h5 className="text-lg lg:text-xl text-center font-bold ">
      ...
      <Card id="alberta">
        ...
        <div className="flex flex-col justify-center items-center">
          <div className="flex flex-col space-y-0.5 items-center">
            <h5 className="text-sm font-semibold italic ">
              July 2019 - Sept. 2019: Edmonton, AB, Canada
            </h5>
          </div>
          <h5 className="text-lg lg:text-xl text-center font-bold ">
        ...
        {/*           </li> */}
        {/*           <li className='p-3 hover:bg-primary '> */}
        {/*             Set up a data acquisition system with the light-field engine */}
        {/*             and the camera’s SDK */}
        {/*           </li> */}
        {/*           <li className='p-3 hover:bg-primary '> */}
        {/*             Reproduced state of the art results on NYU hand pose dataset */}
        {/*             using PyTorch */}
        {/*           </li> */}
        {/*         </ul> */}
        {/*       </div> */}
      ...
      <Card id="uestc">
        ...
        {/*           </li> */}
        {/*           <li className='p-3 hover:bg-primary '> */}
        {/*             Led a team project of 8 students on a smart robot built with */}
        {/*             Raspberry Pi */}
        {/*           </li> */}
        {/*         </ul> */}
        {/*       </div> */}
        ...
        {/*         </li> */}
        {/*         <li className='p-3 hover:bg-primary '>Digital Communication</li> */}
