...
const Blob = () => {
  return (
    <div aria-hidden="true">
      <div className="relative h-40 blob md:h-56 lg:h-64">
        <svg
          className="h-full fill-current animate-blob-spin text-gray-200"
          viewBox="0 0 278 279"
...
export const Home = (): JSX.Element => (
  <div className="flex flex-col-reverse items-center mt-12 lg:flex-row lg:justify-between lg:space-x-6">
    <p className="max-w-3xl mt-12 text-3xl font-semibold text-right lg:mt-0 sm:text-4xl sm:text-left md:text-center lg:text-left">
      A fervent programmer, lifelong learner, and sometimes jerk.
      <br /> Shhhh! I'm going to go get some 🍟 on the pier.
    </p>
    <div className="relative">
      <Blob />
      <div className="absolute top-0 flex items-center justify-center w-full h-full">
        <div className="w-32 h-32 overflow-hidden rounded-lg md:h-40 md:w-40 lg:h-48 lg:w-48">
          <Fries className="w-32 h-32 md:h-40 md:w-40 lg:w-48 lg:h-48" />
        </div>
      </div>
    </div>
  </div>
